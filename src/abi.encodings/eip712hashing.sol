/**
 *  source copied from https://github.com/Cyfrin/security-and-auditing-full-course-s23/blob/main/eip712hashing.sol
 *  looks like a test implementation of EIP 712 for hashing + signing typed structured data
 *  https://eips.ethereum.org/EIPS/eip-712
 *
 *  some modifications made to original code:
 *  1. SPDX license identifier added
 *  2. solidity version changed from 0.4.24 to 0.8.24
 *  3. constructor() public keyword removed
 *  4. memory keyword added to input args specifications
 */
